...
variable "environment" {
  ...
  validation {
    ...
    error_message = "This configuration is for production environment only."
  }
}
...
variable "primary_subnet_cidr" {
  ...
  type        = string
  default     = "10.30.0.0/20" # 4,096 IPs
}

variable "pods_secondary_cidr" {
  description = "CIDR range for GKE pods"
  type        = string
  default     = "10.34.0.0/14" # 262,144 IPs
}

variable "services_secondary_cidr" {
  description = "CIDR range for GKE services"
  type        = string
  default     = "10.38.0.0/20" # 4,096 IPs
}
...
variable "db_availability_type" {
  ...
  type        = string
  default     = "REGIONAL" # Multi-zone HA
}
...
variable "redis_tier" {
  ...
  type        = string
  default     = "STANDARD_HA" # Multi-zone HA for staging
}
